...
#define ONE_WIRE_BUS 5 // и настраиваем  пин 9 как шину подключения датчиков DS18B20
...
#define ACTIV_Pin 4    // на светодиод через транзистор, c 10-го пина для индикации активности 
  ...
  if (m590.available()) { // если что-то пришло от модема 
    ...
    if (at.indexOf("RING") > -1) {
      ...
      Serial.println("Incoming call is cleared"),WarmUpTimer = 60, start = true;
         ...
         m590.print("#M5-12-56-78-45-78#M590+Sensor"); // индивидуальный номер для народмона
